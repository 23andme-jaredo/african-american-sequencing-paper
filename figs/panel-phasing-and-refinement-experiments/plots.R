...
plt <- ggplot(bakeoff,aes(x=af,y=r2,lty=phaser,col=caller2))
plt <- plt+geom_line()+facet_grid(rows=vars(paste(truth,'truth')),cols=vars(variant))+scale_x_log10(breaks=10**(-4:0))+theme_bw()
